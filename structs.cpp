...
std::vector<Point2f> Rectf::GetVertices() const
{
	...
	points.push_back(Point2f(left, bottom));
	points.push_back(Point2f(left, bottom + height));
	points.push_back(Point2f(left + width, bottom + height));
	points.push_back(Point2f(left + width, bottom));
